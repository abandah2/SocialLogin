...
public class GoogleHelper implements GoogleApiClient.OnConnectionFailedListener {
        ...
        AsyncTask<Void, Void, String> task = new AsyncTask<Void, Void, String>() {
          ...
          protected String doInBackground(Void... params) {
            ...
            try {
              ...
              Utility.hideCircleProgressDialog();
              e.printStackTrace();
            }
            return token;
          }
          ...
          protected void onPostExecute(String token) {
            ...
            Bitmap bitmap = null;
            try {
              bitmap = GetProfilePicFromid(acct.getPhotoUrl().toString());
            } catch (Exception e) {
              e.printStackTrace();
            }
            mListener.onGoogleAuthSignIn(token, acct,bitmap);
          }
        };
        task.execute();
      } else {
  ...
  public Bitmap GetProfilePicFromid(String Url) {
